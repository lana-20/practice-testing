...
| Expand Testing | https://practice.expandtesting.com/ | 10,407 | $0.000 | 101,214 | $1.588 | 9.7× | N/A | Login button obscured — use eval click; valid login: practice / SuperSecretPassword!; **CLI anomaly: daemon i/o timeout** on first navigate (87,302ms); normal CLI ratio ~5.7× |
...
| OrangeHRM | https://opensource-demo.orangehrmlive.com/ | 4,614 | $0.000 | 327,680 | $0.946 | 71.0× | N/A | HR management SPA; map returns nothing in both interfaces — eval required for all interactions; login: Admin / admin123; 2.0× reflects heavy JS init time equalizing overhead |
