...
| OrangeHRM | https://opensource-demo.orangehrmlive.com/ | 7,406 | $0.000 | 240,839 | $0.946 | 32.5× | N/A | HR management SPA; map returns nothing in both interfaces — eval required for all interactions; login: Admin / admin123; 2.0× reflects heavy JS init time equalizing overhead |
...
| Swag Labs | https://www.saucedemo.com/ | 3,271 | $0.000 | 246,335 | $0.981 | 75.3× | N/A | Clean login→inventory→add-to-cart; login: standard_user / secret_sauce; 6 inventory items; no mandatory sleeps → overhead fully exposed |
